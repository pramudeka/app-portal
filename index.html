...
<html lang="en">
    <head>
        ...
        <title>Layanan Pemkab Blitar</title>
        <!-- Favicon-->
    ...
    <body id="page-top" class=" d-flex  flex-column">
        ...
        <section class="page-section  flex-grow-1" id="portfolio">
            ...
            <div class="sticky-top kat">
                <div class="mini-headers">
                    <img src="assets/img/logo-kab.png">
                    <span class="header-title">Mall Pelayanan Publik</span>
                    <a href="javascript:void(0);" class="icon">
                        <i class="fa fa-bars"></i>
                    </a>
                </div>
                <h3 class="section-heading" hidden>Kategori</h3>
                <ul id="portfolio-flters" class="text-center">
                  <span class="section-heading text-uppercase">Kategori :</span>
            ...
            <div class="container">
                ...
                <div class="row item-list" >
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-kab filter-surat">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://apeldeskel.blitarkab.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-1.jpg" alt="Apeldeskel | Aplikasi layanan surat menyurat di wilayah DesaKelurahan" />
                            </a>
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-surat">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://mail.google.com/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-2.jpg" alt="Gmail | Layanan surat menyurat elektronik (e-mail) milik Google" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-surat">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://mail.yahoo.com/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-3.jpg" alt="Ymail | Layanan surat menyurat elektronik (e-mail) milik Yahoo" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-ijin">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://www.oss.go.id/oss/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-4.jpg" alt="OSS | Perijinan berusaha terintegrasi secara elektronik / Online Single Submission" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-ijin filter-kab">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://i-mobil.blitarkab.go.id/web/home">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-5.jpg" alt="I-Mobil | Layanan mengajukan ijin usaha di DPMPTSP" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-kab filter-extra">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://skmdev.blitarkab.go.id/user/login">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-6.jpg" alt="SKM | Data dan informasi tingkat kepuasan masyarakat tentang pelayanan publik Kabupaten Blitar" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://www.pln.co.id/pelanggan/layanan-online">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-7.jpg" alt="Pendaftaran Listrik | Layanan PLN untuk pendaftaran listrik secara online" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://antrian.bpjsketenagakerjaan.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-8.jpg" alt="BPJS Ketenagakerjaan | Layanan jaminan sosial ketenagakerjaan" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar filter-kab">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://siak.blitarkab.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-9.jpg" alt="E-Siap | Layanan pendaftaran data kependudukan (KTP, KK, Akte Kelahiran, dll) secara online" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://subsidi.djk.esdm.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-10.jpg" alt="Subsidi Listrik | Layanan PLN utuk mengajukan dan mengadukan subsidi listrik" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://ereg.pajak.go.id/login">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-11.jpg" alt="NPWP | Layanan pendaftaran NPWP secara online" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-bayar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://www.pajak.go.id/id/e-billing">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-12.jpg" alt="E-Billing | Layanan pembayaran pajak secara online menggunakan kode billing" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://antrian.imigrasi.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-13.jpg" alt="Pendaftaran Paspor | Layanan pendaftaran paspor secara online" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar filter-info filter-kab">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://gotki.blitarkab.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-14.jpg" alt="Go TKI | Layanan pendaftaran calon TKI di luar negeri di Disnaker" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://www.online-pajak.com/e-filing">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-15.jpg" alt="E-Filing | Layanan penyampaian Surat Pemberitahuan (SPT) secara online" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-bayar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://www.kai.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-16.jpg" alt="Tiket KAI | Layanan pembelian tiket kereta api" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-kab">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://ikm.blitarkab.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-17.jpg" alt="Katalog IKM | Informasi produk Industri Kecil Menengah (IKM)" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-kab ">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://www.blitarkab.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-18.jpg" alt="blitarkab.go.id | Website resmi Pemerintah Kabupaten Blitar" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://eform.bankjatim.co.id/eformbjtm/home">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-19.jpg" alt="Kredit Bank Jatim | Informasi kredit dan pengajuan kredit di Bank Jatim" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://skck.polri.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-20.jpg" alt="SKCK Online | Layanan pendaftaran SKCK secara online" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://jobsinfo.bnp2tki.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-21.jpg" alt="Info Pekerjaan Luar Negeri" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://esamsat.jatimprov.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-22.jpg" alt="E-Samsat | Layanan cek pajak kendaraan bermotor secara online menggunakan NOPOL" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://eraterang.badilum.mahkamahagung.go.id/masuk">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-23.jpg" alt="Eraterang | Layanan permohonan surat keterangan pada pengadilan negeri secara elektronik" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar filter-info filter-bayar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://ecourt.mahkamahagung.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-24.jpg" alt="E-Court | Layanan pendaftaran perkara, taksiran panjar biaya perkara, pembayaran, pemanggilan hingga sidang" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar filter-kab">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://layanan.dispendukcapil.blitarkab.go.id/antrian/login.php">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-25.jpg" alt="Antrian Dispendukcapil | Layanan pendaftaran antrian di Dispendukcapil secara online" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-kab">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://sipp.pa-blitar.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-26.jpg" alt="SIPP | Sistem Informasi Penelusuran Perkara oleh Pengadilan Agama Kabupaten Blitar" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://sim.korlantas.polri.go.id/devregistrasi/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-27.jpg" alt="Pendaftaran SIM | Layanan pendaftaran SIM secara online oleh Korlantas Polri" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://ahu.go.id/sabh/perseroan/pesannama">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-28.jpg" alt="Pencatatan Persero | Pencatatan dan pemesanan nama persero, yayasan maupun perkumpulan oleh Kemenkumham" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://ula.kemendagri.go.id/daftar">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-29.jpg" alt="Pendaftaran Ormas | Layanan pendaftaran organisasi masyarakat secara online di Kemendagri" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-bayar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://transaksi.klikmbc.co.id/ppob/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-30.jpg" alt="PPOB | Layanan transaksi pembayaran tagihan dalam satu tempat" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://lelang.go.id/kantor/66/KPKNL-Malang.html">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-31.jpg" alt="Lelang | Layanan proses lelang aset pemerintah daerah" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://cekbpom.pom.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-32.jpg" alt="Cek BPOM | Layanan pengecekan produk obat dan makanan yang telah mendapat petsetujuan ijin edar oleh BPOM" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://e-lppommui.org/new/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-33.jpg" alt="Halal MUI | Sertifikasi halal untuk perusahaan makanan, kosmetik, dan obat-obatan oleh MUI" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://info.dipendajatim.go.id/index.php?page=info_pkb">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-34.jpg" alt="PKB | Layanan informasi pajak kendaran bermotor oleh Dipenda Pemprov Jatim" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-ijin">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://simbg.pu.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-35.jpg" alt="IMB | Layanan perijinan membangun baru, mengubah, memperluas, mengurangi, dan/atau merawat bangunan gedung" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-kab">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://blitarkab.bps.go.id/publication.html">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-36.jpg" alt="Kecamatan Dalam Angka | Gambaran perkembangan Kecamatan di Kabupaten Blitar menurut Badan Pusat Statistik" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-kab">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://ehealth.blitarkab.go.id/#home">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-37.jpg" alt="E-Health | Layanan kesehatan Pemerintah Kabupaten Blitar" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://www.indonesiabaik.id/infografis/cek-nomor-porsi-untuk-perkiraan-berangkat-haji">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-38.jpg" alt="Perkiraan Haji | Layanan cek nomor porsi untuk perkiraan berangkat haji" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-bayar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="https://www.tokopedia.com/pajak/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-39.jpg" alt="Pembayaran Pajak di Tokopedia | Layanan pembayaran pajak tahunan dan PPOB melalui Tokopedia" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://simkah.kemenag.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-40.jpg" alt="Simkah | Sistem Informasi Manajemen Nikah oleh Kemenag" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-ijin">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://izin.p2t.jatimprov.go.id/">
                                ...
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-41.jpg" alt="Ijin P2T | Pelayanan Perijinan Terpadu oleh Pemprov Jatim" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-ijin filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://inatrade.kemendag.go.id/index.php/registrasi">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-42.jpg" alt="Inatrade | Layanan perijinan pendaftaran eksport-import oleh Kemendag" />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class=" col-xl-2 col-lg-2 col-md-3 col-sm-3 mb-4 portfolio-item filter-info filter-kab filter-daftar">
                        <!-- Portfolio item 1-->
                            <a class="portfolio-link" href="http://ppdb.blitarkab.go.id/">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"></div>
                                </div>
                                <img class="img-fluid" src="assets/img/icon/ikon portals_design-43.jpg" alt="PPDB Online | Layanan pendaftaran penerimaan peserta didik baru di Kabupaten Blitar" />
                            </a>
                            <div class="portfolio-caption">
        ...
        <footer class="footer py-4">
            <div class="container">
                    ...
                    <div class="col-lg-12 text-center mb-4">
                        <a href="https://forms.gle/KffbGtNErNEv9tvN8" class="survey btn btn-sm"><i class="fa-solid fa-comment-dots"></i><span>&nbsp; Saran & Masukan</span></a>
                    </div>
                <div class=" ">
